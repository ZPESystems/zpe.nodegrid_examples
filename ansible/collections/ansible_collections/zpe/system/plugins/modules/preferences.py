...
from ansible_collections.zpe.system.plugins.module_utils.preferences_util import get_module_params
from ansible_collections.zpe.system.plugins.module_utils.preferences_util import get_nodegrid_dict
...
def get_config():
    cmd = "cli -c export_settings /settings/system_preferences/ --plain-password"
