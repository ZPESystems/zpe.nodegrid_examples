...
class Panos:
    def __init__(self, module):
        ...
        self.connection_args['target_type'] = 'panos'
        ...
        self.connection_args['cmds_init'] = [
                {"cmd": "set cli pager off", "template": ""},
                {"cmd": "set cli terminal width 500", "template": ""}
            ]
        self.connection_args['send_cmds_init'] = module['send_cmds_init']
        if self.connection_args['action'] == "fact":
            self.connection_args['cmds'] = [
                {"cmd": "show system info", "template": "panos_show_system_info"}
            ]
        else:
